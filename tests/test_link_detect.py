...
def test_youtube_link_replaced_with_embed():
    ...
    test_url = "https://www.youtube.com/watch?v=5qap5aO4i9A"
    expected_text = f"<iframe width='560' height='315' src='https://www.youtube.com/embed/5qap5aO4i9A' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media;' allowfullscreen></iframe>"
